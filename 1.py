...
try:
    ...
    import platform
    import getpass
    # Remove problematic imports for Termux
    # import pytgin  # Comment out for Termux compatibility
...
if __name__ == "__main__":
    try:
        ...
        print(f"{Fore.CYAN}╔══════════════════════════════════════════════════════════╗{Style.RESET_ALL}")
        t_a = Handler.integer_handler(f"{StaticValues.WAITING}Threads (1-5) ➤ ")
        print(f"{Fore.CYAN}╚══════════════════════════════════════════════════════════╝{Style.RESET_ALL}")
